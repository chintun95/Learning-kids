        ...
        <View style={styles.overlay}>
          ...
          <View style={styles.actionsContainer}>
            <TouchableOpacity onPress={() => setShowEditProfileModal(true)}>
              <Text style={styles.actionText}>View/Update Profile Info</Text>
            </TouchableOpacity>
      ...
      <Modal visible={showEditProfileModal} animationType="slide">
        ...
        >
          ...
          <ScrollView
            ...
            showsVerticalScrollIndicator={false}
          >
            <Text style={styles.fullscreenTitle}>Edit Profile</Text>
              ...
              {imageSource && (
                <Image
                  ...
                  style={{
                    ...
                    height: responsive.screenWidth * 0.4,
                    borderRadius: 999,
                    alignSelf: "center",
